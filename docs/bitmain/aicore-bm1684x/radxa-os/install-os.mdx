...
本文档将介绍如何把 radxa-aicore-bm1684x OS 镜像安装到 radxa-aicore-bm1684x。
...
请到 [快速上手下的资源下载汇总](/bitmain/aicore-bm1684x/getting-started/download.md)下载对应的镜像文件
...
<img src="/img/aicore-bm1684x/rufus-use.webp" alt="radxa-aicore-bm1684x interfaces" />


### 2.请将下载的压缩包解压到 SD 卡根目录

### 3.SD卡刷机

请将 BM1684X 断电，插入 SD 卡，并连接串口终端，然后给 BM1684X 上电。您将看到
BM1684X 自动进入刷机流程：
```
...
- 按照上述步骤成功烧录镜像到emmc后，将 microSD 卡拔出，然后给 BM1684X 上电。
